    ...
    <section>
      ...
      <div>
        <div className="border-b border-gray-200 er">
          <nav
            className="flex gap-x-1 justify-center px-20"
            aria-label="Tabs"
            role="tablist"
        ...
        <div className="mt-3">
          {activeTab === "about" && (
            ...
            >
              <h2 className="flex justify-left w-full text-left text-3xl p-2 mt-4">
                Issey Miyake Cream Oversize shirt
              </h2>
              <p className="flex justify-left w-full text-left p-2">
                <strong>Ethical Rating:</strong> 8/10
              </p>
              <p className="flex justify-left w-full text-left p-2">
                <strong>Origin:</strong> Japan
              </p>
            </div>
          )}
          {activeTab === "journey" && (
